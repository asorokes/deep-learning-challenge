...
Continue using the file in Google Colab or Jupyter Notebook in which you performed the preprocessing steps from Step 1.
...
1) ReadMe File
2) Written report
3) AlphabetSoupCharity_Optimization.ipynb- contains all three iterations of model testing

All code used in this assignment was created using resources from class, collaborative efforts with classmates, and other resources found online. 
